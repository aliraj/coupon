package com.roof.coupon.core.file.impl;
...
import com.roof.coupon.core.file.api.IFpaPicService;
import com.roof.coupon.cos.api.ICosService;
...
public class FpaPicServiceImpl implements IFpaPicService,InitializingBean {
    ...
    //Cache<Object, Object> cache = CacheBuilder.newBuilder().maximumSize(50).build();
