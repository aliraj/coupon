package com.roof.coupon.banner.controller;
...
@Api(value = "banner", description = "推广位管理")
@Controller
@RequestMapping("coupon")
public class BannerController {
	private IBannerService bannerService;

	@ApiOperation(value = "获得推广位基础信息")
