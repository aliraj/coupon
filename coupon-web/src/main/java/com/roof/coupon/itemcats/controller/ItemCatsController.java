...
public class ItemCatsController {
    ...
    public @ResponseBody Result<Page> list(ItemCats itemCats, HttpServletRequest request) {
	...
	public @ResponseBody Result create(@RequestBody ItemCats itemCats) {
		if (itemCats != null) {
    ...
    public @ResponseBody Result<ItemCatsVo> load(@PathVariable Long id) {
	...
	public @ResponseBody Result update(@PathVariable Long id ,@RequestBody ItemCats itemCats) {
